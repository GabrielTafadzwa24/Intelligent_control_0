...
setup(
    ...
    entry_points={
        'console_scripts': [
            'intelligent_control = intelligent_control.intelligent_control:main',
            'arm_vehicle = intelligent_control.arm_vehicle:main',
            'vehicle_control = intelligent_control.vehicle_control:main',
            'mission_control = intelligent_control.mission_control:main',
