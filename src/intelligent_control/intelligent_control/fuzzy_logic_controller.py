...
class FuzzyNavigation(Node):
    ...
    def _create_fuzzy_rules(self):
        ...
        rules = [
            ...
            ctrl.Rule(cte['small_left'], left['fast']),
            ctrl.Rule(cte['small_left'], right['slow']),

                # Right turn corrections (reduce right motor speed)
            ctrl.Rule(cte['small_right'], left['slow']),
            ctrl.Rule(cte['small_right'], right['fast']),
    ...
    def compute_navigation_parameters(self):
        ...
        self.cross_track_error = self.compute_heading_error()
    ...
    def publish_motor_commands(self, left_motor_speed, right_motor_speed):
        ...
        self.get_logger().info(
            ...
            f"Motors L/R: {left_motor_speed:.2f}/{right_motor_speed:.2f}")
